...
function LoadArticle()
{
	...
	document.getElementById('theme').addEventListener('input',function(){sessionStorage.setItem('theme',document.getElementById('theme').options[document.getElementById('theme').selectedIndex].value);location.href=location.href.replace(/[?&]theme=[^&]*/g,'');});
}
