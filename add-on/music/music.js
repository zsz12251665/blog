...
function LoadMusic()
{
	...
	for(let audio of document.querySelectorAll('article audio'))
	{
		...
		music.querySelector('b.repeat').onclick=function(e){e.target.innerHTML=(audio.loop=!audio.loop)?'&#128257;':'&#128256;';};
		audio.ontimeupdate();
	}
}
