...
function LoadMusic()
{
	...
	document.querySelector('#music').innerHTML+='<audio src="/posts/'+request.title+'/music.mp3" preload="auto"></audio><b id="play">&#9205;</b><span id="time">00:00/00:00</span><b id="repeat">&#128257;</b><span class="range"><span id="volume"></span></span><b id="mute">&#128266;</b>';
	// Initialize values
	...
	document.querySelector('#repeat').onclick=function(e){e.target.innerHTML=(audio.loop=!audio.loop)?'&#128257;':'&#128256;';};
}
