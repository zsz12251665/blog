...
function LoadHighlight()
{
	...
	softTab.innerHTML+='<input type="checkbox" />Replace tabs with 4 spaces';
	...
	softTab.onclick=function(){sessionStorage.setItem('softTab',softTab.checked);for(let code of document.querySelectorAll('code'))code.innerHTML=softTab.checked?code.innerHTML.replace(/\t/g,'&nbsp;&nbsp;&nbsp;&nbsp;'):code.innerHTML.replace(/(&nbsp;){4}/g,'\t');};
	softTab.onclick();
}
